...
EXECUTIVE_TEXT = '''# Análise Executiva
...
HANDOFF_TEXT = '''# Final Handoff Report
...
def main():
    ...
    (DOCS / 'executive_analysis.md').write_text(EXECUTIVE_TEXT, encoding='utf-8')
    (DOCS / 'final_handoff_report.md').write_text(HANDOFF_TEXT, encoding='utf-8')
